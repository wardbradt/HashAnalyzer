...
public class HashAnalyzer {
    /*
     * hashTable is a PriorityQueue of HashedLinkedLists (HLLs). each HLL stores an Integer hash code at its head node.
     * The contents of the rest of the nodes in each HLL are instances of the same class whose hash code is
     * equivalent to the value of the head node.
     */
    private PriorityQueue<HashedLinkedList<Object>> hashTable;
     ...
     */
    public HashAnalyzer(Class c, int[] r) {
    ...
    public HashAnalyzer(Class c, Constructor<?> constructor, int[] r) {
        hashTable = new PriorityQueue<>();
        analyzedClass = c;
    ...
    /**
     * Generates 1024 instances of analyzedClass <code>Object</code>s using a constructor specified by the constructor
   ...
   public LinkedList<Object> generateRandomTable(int[][] ranges) {
    ...
    public String heatMap() {
        ...
        PriorityQueue<HashedLinkedList<Object>> copy = new PriorityQueue<>();
...
//        orderedJumps.addAll(copy);
    ...
    public long hashTableAdd(Object obj) {
        ...
        // if this is the first CLL being added to hashTable
        if (hashTable.size() == 0) {
            HashedLinkedList<Object> adding = new HashedLinkedList<>(hashed);
            adding.add(obj);
    ...
    public void setHashTable(PriorityQueue<HashedLinkedList<Object>> x) {
        hashTable = x;
    }
